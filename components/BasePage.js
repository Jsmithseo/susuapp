...
const BasePage = props => {
  ...
  const {
    ...
    className = '',
    header,
    title = "Portfolio - Jeremy Smith",
    metaDescription="My name is Jeremy Smith and I am an experienced software engineer and freelance developer. Throughout my career, I have acquired advanced technical knowledge and the ability to explain programming topics clearly and in detail to a broad audience.",
    canonicalPath,
    children } = props;
